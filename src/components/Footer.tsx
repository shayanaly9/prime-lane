        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-24">
           ...
           <Link href="/help-centre/contact" className="group relative">
              <motion.div 
                ...
                whileTap={{ scale: 0.98 }}
                className="px-16 py-8 bg-white text-ink font-bold rounded-full text-xl shadow-2xl transition-all duration-500 overflow-hidden"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4 space-y-12">
            <Link href="/" className="inline-block">
              <Image src="/Prime-lane-logo.png" alt="PrimeLane" width={160} height={48} className="brightness-0 invert opacity-60" />
            </Link>
            
            {/* Perpetual Status Indicator (isolated logic feel) */}
            <div className="inline-flex items-center gap-4 px-6 py-3 bg-white/5 border border-white/10 rounded-full">
               <div className="relative flex h-2 w-2">
                 <div className="absolute inset-0 rounded-full bg-teal animate-ping opacity-20" />
                 <div className="relative rounded-full h-2 w-2 bg-teal shadow-[0_0_10px_var(--c-teal)]" />
               </div>
               <span className="text-[10px] font-bold tracking-[0.2em] uppercase text-white/40">Systems Operational</span>
            </div>
          ...
          <div className="lg:col-span-3 space-y-10">
            <h4 className="text-[10px] font-bold tracking-[0.3em] uppercase text-teal">Capabilities</h4>
            <ul className="space-y-6">
              {[
                ...
                <li key={label}>
                  <Link href={href} className="text-white/40 hover:text-white transition-all text-sm font-medium tracking-tight group flex items-center gap-3">
          ...
          <div className="lg:col-span-3 space-y-10">
            <h4 className="text-[10px] font-bold tracking-[0.3em] uppercase text-teal">Protocol</h4>
            <ul className="space-y-6">
              {[
          ...
          <div className="lg:col-span-2 space-y-10">
            <h4 className="text-[10px] font-bold tracking-[0.3em] uppercase text-teal">Global Desk</h4>
            <div className="space-y-8">
              <div>
                <p className="text-[10px] font-bold text-white/20 uppercase tracking-widest mb-3">Technical Support</p>
              ...
              <div>
                <p className="text-[10px] font-bold text-white/20 uppercase tracking-widest mb-3">Direct Protocol</p>
                <a href="mailto:contact@primelanelogistics.com.au" className="text-xs font-bold text-white/60 hover:text-white border-b border-white/10 pb-1 hover:border-teal transition-all">contact@primelane.com.au</a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex items-center gap-12 overflow-hidden w-full md:w-auto">
             <div className="flex gap-24 animate-marquee whitespace-nowrap">
                {['ISO 9001 CERTIFIED', 'DG CLASS 2–9 LICENSED', 'IATA MEMBER', 'AU-UAE SPECIALIST'].map(cert => (
                  <span key={cert} className="text-[10px] font-bold tracking-[0.6em] text-white/10 uppercase">{cert}</span>
                ))}
             </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
             ...
             <button 
               ...
               className="group flex items-center gap-4 text-[10px] font-bold tracking-widest text-white/40 hover:text-white uppercase transition-all"
             >
                TOP
